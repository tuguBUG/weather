$(document).ready(function(){
    ...
    var myKey = "16b257685e5eda848270cfefe6594d4b";
        ...
        $("#weather li").each(function(index){
            $.ajax({
                ...
                success : function(data){
                    ...
                    console.log(this);  //{url: 'https://api.openweathermap.org/data/2.5/weather?q=Seoul&appid=1451c23e29ef1202473d5f41f30131c2', type: 'GET', isLocal: false, global: true, processData: true, …}
